...
def menu(update: Update, _: CallbackContext) -> int:
    ...
    elif update.message.text == i18n_format("keyboard.coin_forecast"):
...
MENU_HANDLER = MessageHandler(
    Filters.regex(
        f"^({i18n_format('keyboard.current_value')}|{i18n_format('keyboard.panic')}|{i18n_format('keyboard.progress')}|{i18n_format('keyboard.current_ratios')}|{i18n_format('keyboard.next_coin')}|{i18n_format('keyboard.check_status')}|{i18n_format('keyboard.bot_stats')}|{i18n_format('keyboard.coin_forecast')}|{i18n_format('keyboard.trade_history')}|{i18n_format('keyboard.graph')}|{i18n_format('keyboard.maintenance')}|"
